...
import SlotManagement from './pages-v2/SlotManagement';
import TestingV2 from './pages-v2/TestingV2';
import TrainingV2 from './pages-v2/TrainingV2';
        ...
        <Layout>
          ...
          <Content className="main-content" style={{ padding: '24px', minHeight: 'calc(100vh - 64px)' }}>
            ...
            <Routes>
              ...
              <Route path="/libraries" element={<LibraryManagement onLibrarySelect={setCurrentLibrary} />} />
